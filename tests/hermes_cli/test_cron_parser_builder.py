...
def test_cron_create_options():
    ...
    assert ns.pause_after_delivery is True
...
def test_cron_edit_pause_after_delivery_tristate():
    parser = _build()
    assert parser.parse_args(["cron", "edit", "j", "--pause-after-delivery"]).pause_after_delivery is True
    assert parser.parse_args(["cron", "edit", "j", "--keep-running-after-delivery"]).pause_after_delivery is False
    assert parser.parse_args(["cron", "edit", "j"]).pause_after_delivery is None
